...
int gpio_led_control_probe(struct platform_device *);
int gpio_led_control_remove(struct platform_device *);
...
struct platform_driver gpio_led_control_platform_driver = 
{
...
int gpio_led_control_probe(struct platform_device *pdev)
{
    const char *name;
    int i = 0;
    int ret;
...
int gpio_led_control_remove(struct platform_device *pdev)
{
    int i;
...
int __init gpio_led_control_init(void)
{
    int ret;
...
void __exit gpio_led_control_exit(void)
{
